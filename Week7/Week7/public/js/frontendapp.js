$(document).ready(function () {
            ...
            $.ajax({
                ...
                if (status && data) {
                    ...
                    $('#userList tbody').append(
                        `<tr class="user-id" data-userid="${data._id}"><td scope="row">${data._id}</td><td class="username">${data.username}</td><td class="name">${data.name}</td><td class="gender">${data.gender}</td><td><button class="del-btn btn btn-danger" data-id="${data._id}">Delete</button><button class="update-btn btn btn-warning" data-id="${data._id}">Update</button></td></tr>`
                    )
                    $(`button.del-btn[data-id="${data._id}"]`).click(function (e) {
                    ...
                    $(`button.update-btn[data-id="${data._id}"]`).click(function (e) {
                        const userId = $(this).attr('data-id')
    ...
    $.ajax({
        ...
        data.forEach(function (val) {
            $('#userList tbody').append(
                `<tr class="user-id" data-userid="${val._id}"><td scope="row">${val._id}</td><td class="username">${val.username}</td><td class="name">${val.name}</td><td class="gender">${val.gender}</td><td><button class="del-btn btn btn-danger" data-id="${val._id}">Delete</button><button class="update-btn btn btn-warning" data-id="${val._id}">Update</button></td></tr>`
            )
        })
